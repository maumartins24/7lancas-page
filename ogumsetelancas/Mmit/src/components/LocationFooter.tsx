    ...
    <footer className="bg-gradient-to-t from-blue-900 to-blue-700 dark:from-red-900 dark:to-red-700 py-16 transition-all duration-500">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          {/* Logo and Community Info */}
          <div className="text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start mb-8">
              <div className="w-16 h-16 bg-white dark:bg-black rounded-2xl flex items-center justify-center mr-4 shadow-lg">
                <svg className="w-10 h-10 text-blue-600 dark:text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 className="text-3xl font-bold text-white">Terreiro Ogum 7 Lanças</h3>
            </div>
            ...
            <div className="space-y-4 text-white/90">
              ...
              <div className="flex items-center justify-center lg:justify-start">
                ...
                <span>terreiroogumsetelancas@gmail.com</span>
              </div>
            </div>
          ...
          {/* Map */}
          <div className="h-96 rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
            <MapContainer
              center={position}
              zoom={13}
